...
public class Reservation {
    ...
    public Reservation(int roomId, LocalDate checkInDate, LocalDate checkOutDate, double totalPrice, String guestName, int guestCitizenId, String guestMail, String guestPhone) {
        this.roomId = roomId;
